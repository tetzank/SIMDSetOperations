...
size_t difference_scalar_stl(const uint32_t *list1, size_t size1, const uint32_t *list2, size_t size2, uint32_t *result){
	uint32_t *endresult = std::set_difference(list1, list1+size1, list2, list2+size2, result);
